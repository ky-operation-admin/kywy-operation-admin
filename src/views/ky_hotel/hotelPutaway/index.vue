<template>
  <div class="app-container">
    <div class="title" style="text-align:left;padding:20px">
      <el-input v-model="keyword" placeholder="请输入酒店名称/电话/法人姓名" style="width: 300px;margin-right:-10px;" clearable class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    <el-table :data="tableData" style="width: 100%" border v-loading="listLoading">
      ...
      <el-table-column prop="hotel_serve" label="房间" align="center"></el-table-column>
