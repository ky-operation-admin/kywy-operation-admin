<template>
  <div id="org" class="app-container">
    <div class="title" style="text-align:left;padding:20px">
      <el-input v-model="listQuery.keyword" @keyup.enter.native="handleFilter" placeholder="请输入商家名称/法人姓名/电话号码" style="width: 300px" clearable class="filter-item" />
  ...
  methods: {
    initData () {
      ...
      let tempData1 = onsaleDatatemp.filter(item => {
        return item.merchant_name.includes(this.listQuery.keyword)
      })
