    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="全部" name="first" class="onsale">
        <el-table :data="onsaleData" border>
          <el-table-column prop="res_name" align="center" label="下单人"></el-table-column>
          ...
          <el-table-column prop="formnum" label="房间编号" align='center'></el-table-column>
      ...
      <el-tab-pane label="待审核" name="second" class="havebought">
        <el-table :data="onsaleData0" border v-loading="listLoading">
          ...
          <el-table-column prop="merchant_name" label="商家名称" width="280" align='center'></el-table-column>
          <el-table-column prop="xinyong" label="房间类型" align='center'></el-table-column>
          <el-table-column prop="pingji" label="价格" align='center'></el-table-column>
          <el-table-column prop="busLicen" align="center" label="图片">
            <template slot-scope="scope">
      ...
      <el-tab-pane label="未通过" name="fourthly" class="havebought">
        <el-table :data="onsaleData2" border>
          ...
          <el-table-column prop="phone" align="center" label="机器审核报告"></el-table-column>
          <el-table-column prop="org_stateText" align="center" label="审核结果">
            <template slot-scope="scope">
              <div class="payShow">
                <a v-if="scope.row.org_state==1" class="pass">
