    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="全部" name="first" class="onsale">
        <el-table :data="onsaleData" border>
          ...
          <el-table-column prop="postName" align="center" label="发布的职位"></el-table-column>
          <el-table-column prop="department" align="center" label="所属行业"></el-table-column>
          <el-table-column prop="content" align="center" label="职位要求"></el-table-column>
          <el-table-column prop="address" align="center" label="工作地点"></el-table-column>
          <el-table-column prop="compensation" align="center" label="薪资说明"></el-table-column>
