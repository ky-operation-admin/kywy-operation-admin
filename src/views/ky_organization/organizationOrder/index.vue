<template>
  <div class="app-container">
    <div class="title" style="text-align:left;padding:20px">
      <el-input v-model="keyword" placeholder="请输入机构名称/订单编号/下单账号" style="width: 300px;margin-right:-10px;" clearable class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    <el-table :data="tableData" style="width: 100%" border v-loading="listLoading">
      ...
      <el-table-column prop="formnum" label="房型编号" align="center"></el-table-column>
      <el-table-column prop="orderNum" label="订单编号" align="center"></el-table-column>
      <el-table-column prop="serve_type" label="订单类型" align="center"></el-table-column>
